...
PROVIDER_FILES = (
    ...
    "check_security_assessment.py",
    "security_assessment_shared.py",
    "security_assessment_network.py",
    "security_assessment_registry.py",
    "security_assessment_tasks.py",
    "security_assessment_evaluator.py",
    "security_assessment_snapshot.py",
    "security_assessment_v2_common.py",
    "security_assessment_v2_evidence.py",
    "security_assessment_v2_bindings.py",
    "security_assessment_v2_fixtures.py",
    "security_assessment_v2_negative_tests.py",
    "security_assessment_selftest.py",
